...
from port_scanner import PortScanner                     # Optional port scanner for auto-detection (if available)

PORT_SCANNER_AVAILABLE = False  # Set to True if port_scanner module is available
